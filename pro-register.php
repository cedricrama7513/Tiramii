...
<title>Inscription pro — Casa Dessert</title>
...
<div class="wrap">
  ...
  <p class="sub">Après inscription, votre compte est <strong>en attente</strong> jusqu’à validation par Casa Dessert. Vous recevrez un e-mail si nécessaire.</p>
  <form id="reg">

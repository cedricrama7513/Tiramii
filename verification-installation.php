...
echo '<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><title>Vérification casadessert</title></head><body style="font-family:sans-serif;max-width:640px;margin:2rem auto;padding:0 1rem">';

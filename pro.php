<?php
/**
 * Espace professionnels : même habillage que la boutique (nav, panier) + tarifs pro + devis.
 */
...
// Données panier / shop.js (même format que l’accueil)
    ...
    <div class="pro-panel pro-panel--order is-active" role="tabpanel" id="panel-order" aria-labelledby="tab-order">
      <div class="order-card">
        ...
        <p>
          ...
          Ajoutez vos barquettes ou box au panier puis finalisez votre commande comme un client classique. Vous pouvez aussi utiliser le bouton <strong>Panier</strong> dans le menu pour finaliser une commande déjà commencée sur l’accueil.
        </p>
        <p class="hint" style="margin-bottom:1.25rem">
          Tarifs <strong>particuliers (TTC)</strong> affichés sur la boutique. Pour des volumes pro ou tarifs HT, utilisez l’onglet <em>Demande de devis</em>.
        </p>
